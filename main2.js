...
class Home extends Component {
    render() {
        ...
        const newImages = [
            ...
            { source: require('./assets/gambar3.png'), title: 'Sundress', subtitle: '15$' },
            { source: require('./assets/gambar4.png'), title: 'Pkk', subtitle: '15$' },

            
        ];
        const twoimage = [
            { source: require('./assets/gambar4.png'), title: 'Pkk', subtitle: '15$' },
            { source: require('./assets/gambar2.png'), title: 'Pkk', subtitle: '15$' },
            { source: require('./assets/gambar1.png'), title: 'Pkk', subtitle: '15$' },
            { source: require('./assets/gambar3.png'), title: 'Pkk', subtitle: '15$' },
        ];
