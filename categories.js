      ...
      <ScrollView>
        ...
        <View style={styles.categoriesContainer}>
          <TouchableOpacity style={styles.categoryItem}>
            ...
            <Image source={require('./assets/tgs1.png')} style={styles.categoryImage} />
          </TouchableOpacity>
          <TouchableOpacity style={styles.categoryItem}>
            <Text style={styles.categoryText}>Clothes</Text>
            <Image source={require('./assets/tgs2.png')} style={styles.categoryImage} />
          </TouchableOpacity>
          <TouchableOpacity style={styles.categoryItem}>
            <Text style={styles.categoryText}>Shoes</Text>
            <Image source={require('./assets/tgs3.png')} style={styles.categoryImage} />
          </TouchableOpacity>
          <TouchableOpacity style={styles.categoryItem}>
            <Text style={styles.categoryText}>Accessories</Text>
            <Image source={require('./assets/tgs4.png')} style={styles.categoryImage} />
          </TouchableOpacity>
        </View>
      </ScrollView>
    </View>
