  ...
  const renderStars = (rating, ratingCount) => {
    ...
    for (let i = 1; i <= 5; i++) {
      stars.push(
        <Image
          key={i}
          source={i <= rating ? require('./assets/star.png') : require('./assets/icon/unstar.png')}
